...
import 'package:equity_tracker/presentation/widgets/custom_date_picker_dialog.dart';
        ...
        child: GestureDetector(
          ...
          child: Column(
            children: [
                  ...
                  children: [
                    ...
                    Consumer(
                      builder: (context, ref, child) {
                        ...
                        final allOptions = recentTitlesAsync;
              ...
              // --- MAIN CARD: Date, Type Tabs, CategoryEntity Grid ---
              Expanded(
                child: Container(
                      ...
                      Expanded(
                        child: categoriesAsync.when(
                          data: (categories) {
                            ...
                            // Auto-selection of default category '?∵??' (Food) or first available
                            if (_selectedCategoryId == null &&
                                filtered.isNotEmpty) {
                              // Try to find '?∵??' (Food)
                              final defaultCat = filtered.firstWhere(
                                (c) => c.name == '?∵??', // Or 'Food' if english
