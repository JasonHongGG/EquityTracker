...
import '../../core/services/native_backup_service.dart'; // Add this
...
class _SettingsScreenState extends ConsumerState<SettingsScreen> {
  ...
  Future<void> _exportBackup() async {
    try {
      ...
      // 2. Generate JSON
      final backupService = NativeBackupService(ref.read(categoryRepositoryProvider), ref.read(transactionRepositoryProvider));
