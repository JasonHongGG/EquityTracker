...
3. **單一名詞的歧義 (Ambiguity)**：若記帳資料只有 item 有值，且 price、store 皆為 null（這通常代表使用者只輸入了單一個名詞如「熊熊」、「五十嵐」），此時極有可能是店家名稱而非商品。**必須**提問確認，例如：「請問『[item]』是店家名稱還是購買的商品呢？」。
4. **有地點卻無店名**：若 store 為 null，但 locationClue 有值（例如「五妃街」），代表使用者去某處消費但未提店名，**必須**提問：「請問您在 [地點] 的哪一家店吃 [品項] 呢？」。若兩者皆為 null，則無需強制提問店名。
